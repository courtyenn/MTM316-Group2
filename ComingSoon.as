package
{
	...
	public class ComingSoon extends MovieClip
	{
		...
		public function ComingSoon(proj:FlashFlix_Group2Proj)
		{
			manager = proj;
			var ydistance = 550;
		...
		public function scrollRight(event:Event){
			if(-(movieDisplay.x - 1400) < (numberOfMovies * (movieObject.width + 19)))
			{
				movieDisplay.x -=300;
			}
		}
		...
		public function completeHandler(event: Event): void {
			...
			numberOfMovies = data.movies.length;
			//trace(data);
			...
			//trace("The movie title is: " + data.movies[1].title + ", Rated: " + data.movies[0].mpaa_rating + " Critic's Score: " + data.movies[1].ratings.critics_score + ", Image: " + data.movies[0].posters.detailed);
